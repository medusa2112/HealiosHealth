...
export function contentSecurityPolicy(req: Request, res: Response, next: NextFunction) {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    res.setHeader('Content-Security-Policy', [
      ...
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: https://thehealios.com https://cdn.stripe.com",
      "media-src 'self' https://thehealios.com",
      "connect-src 'self' https://api.stripe.com https://thehealios.com",
