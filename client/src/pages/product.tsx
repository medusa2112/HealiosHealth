    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-black">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Product Image */}
            <div className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden">
              <img
                src={productImage}
                alt={product.name}
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Key Benefits:</h3>
                  <div className="space-y-2">
                    {id === 'apple-cider-vinegar' && (
                      <>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 bg-healios-cyan"></div>
                ...
                {/* Guarantee */}
                <div className="bg-gray-50 dark:bg-gray-900 p-4 space-y-2">
