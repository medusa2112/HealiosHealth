...
const marineCollagenEditorialSVG = appleVinegarEditorialImg;
    <!-- Main heading -->
    <text x="0" y="0" font-family="system-ui, sans-serif" font-size="36" font-weight="300" fill="#4c1d95" letter-spacing="1px">KSM-66</text>
    <text x="0" y="45" font-family="system-ui, sans-serif" font-size="36" font-weight="600" fill="#1f2937">ASHWAGANDHA</text>
    <text x="0" y="80" font-family="system-ui, sans-serif" font-size="20" font-weight="300" fill="#8b5cf6" letter-spacing="2px">PREMIUM EXTRACT</text>
    
    <!-- Subheading -->
    <text x="0" y="115" font-family="system-ui, sans-serif" font-size="12" fill="#6b7280" letter-spacing="0.5px">Clinically Studied Adaptogenic Root Extract</text>
    
    <!-- Benefits list -->
    <g transform="translate(0, 145)" font-family="system-ui, sans-serif" font-size="11" fill="#4b5563">
      <text x="0" y="0">• Stress & Cortisol Support</text>
      <text x="0" y="18">• Enhanced Mental Clarity</text>
      <text x="0" y="36">• Physical Performance</text>
      <text x="0" y="54">• Sleep Quality Support</text>
    </g>
  </g>
  
  <!-- Clinical research badge -->
  <g transform="translate(600, 80)">
    <circle cx="0" cy="0" r="32" fill="#ffffff" stroke="#e5e7eb" stroke-width="2" filter="url(#adaptogenicGlow)"/>
    <text x="0" y="-8" text-anchor="middle" font-family="system-ui, sans-serif" font-size="7" fill="#8b5cf6" font-weight="600">50+</text>
    <text x="0" y="2" text-anchor="middle" font-family="system-ui, sans-serif" font-size="7" fill="#8b5cf6" font-weight="600">CLINICAL</text>
    <text x="0" y="12" text-anchor="middle" font-family="system-ui, sans-serif" font-size="7" fill="#8b5cf6" font-weight="600">STUDIES</text>
  </g>
  
  <!-- Premium quality indicator -->
  <g transform="translate(520, 120)" opacity="0.4">
    <path d="M0 0 Q8 -4 16 0 Q8 4 0 0" fill="#8b5cf6"/>
    <path d="M0 0 L8 0" stroke="#6366f1" stroke-width="0.5"/>
  </g>
  
  <!-- Stress wave visualization -->
  <g transform="translate(100, 450)" opacity="0.3">
    <path d="M0 0 Q50 -20 100 0 Q150 20 200 0 Q250 -15 300 0" stroke="#8b5cf6" stroke-width="2" fill="none"/>
    <path d="M0 10 Q50 -10 100 10 Q150 30 200 10 Q250 -5 300 10" stroke="#a855f7" stroke-width="1.5" fill="none"/>
  </g>
</svg>
`)};
