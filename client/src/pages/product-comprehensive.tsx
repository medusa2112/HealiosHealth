    ...
    switch (productId) {
      ...
      case 'probiotics':
        return {
          ...
          sectionHeading: 'Advanced 10 billion CFU\nprobiotic gummies for optimal\ndigestive wellness and immunity.',
          stat1Number: '10B',
          ...
          testimonial: '"These 10 billion CFU probiotic gummies have completely transformed my digestive health and overall wellbeing. The strawberry flavor makes them enjoyable to take daily."',
          testimonialAuthor: 'RACHEL THOMPSON',
          testimonialTitle: 'Registered Nutritionist',
          benefitTitle: 'Advanced gut health support',
          benefitDescription: '10 Billion CFU multi-strain probiotic complex in convenient gummy form supports digestive health, immune function, and overall wellness.',
          ingredientSource: 'Multi-strain probiotic blend (10 billion CFU)',
          ingredientForm: 'Strawberry-flavored chewable gummies',
          ingredientOrigin: 'Laboratory cultured probiotic strains',
          sleepBenefit: false,
